...
public class FileMessageController {
    ...
    public String upLoad(MultipartFile file, int fid, String filesize, Model model) {
        ...
        if (!file.isEmpty()) {
            ...
            String path = "E:\\taskproject\\src\\main\\webapp\\upload\\";
            //获取原文件名
    ...
    public ResponseEntity<byte[]> downLoad(String filename) throws IOException {
        //下载文件的路径(这里绝对路径)
        String filepath= "E:\\taskproject\\src\\main\\webapp\\upload\\"+filename;
    ...
    public String getCount(){
        int count = fileMessageService.getCount();
        String data = "{\"count\":"+count+"}";
        return data;
    }
    @RequestMapping("/getFile")
    @ResponseBody
    public Map<String, List<FileMessage>> getFile(int page, int limit) {
        List<FileMessage> fileMessageList = fileMessageService.getAllFile(page, limit);
        Map<String, List<FileMessage>> map = new HashMap<String, List<FileMessage>>();
    ...
    public int deleteFile(@RequestParam("id") Integer id) {
        ...
        return fileMessageService.deleteFile(id);
    }
