...
<script>
    ...
    layui.use(['jquery', 'table', 'layer', 'form', 'tree'], function () {
        ...
        function page() {
            $.ajax({
                url: 'http://localhost:8080/getClassCount',
                dataType: 'json',
                type: 'get',
                async: false,
        ...
        var tableIns = table.render({
            elem: '#test'
            , url: 'http://localhost:8080/getClass' //改地址是访问地址
            ...
            , cols: [[ //表头
                ...
                , {field: 'classname', title: '班级名称', width: 150, sort: true}
                ...
                case 'add':
                    layer.open({
                        ...
                        btn1:function (index,layero) {
                            ...
                            $.ajax({
                                type:'post',
                                url:'http://localhost:8080/addclass.do',
                                dataType:'html',
                                data:{
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'del') {
                layer.confirm('真的删除行么', function (index) {
                    $.ajax({
                        url: "http://localhost:8080/deleteclass",
                        type: "POST",
                        dataType: "json",
                        data: {
        ...
        <form>
            <div class="usernameWrapDiv">
                ...
                <div class="usernameDiv layui-input-inline">
                    ...
                    <input id="registerUsername" class="layui-input adminInput" type="text" name="username" placeholder="输入班级名称" >
                </div>
            </div>
